...
const tabs = ['Profile', 'Blog', 'Notifications', 'Security'];
  ...
  <div className="rounded-3xl border border-gray-100 bg-white shadow-sm p-6 space-y-6 text-sm">
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <button className="rounded-2xl bg-gray-900 px-6 py-2 text-sm font-semibold text-white">Save</button>
      </div>
    </div>
  </div>
);
  ...
  <div className="space-y-4">
    <div className="rounded-3xl border border-gray-100 bg-white shadow-sm p-6 space-y-5">
      <div>
        ...
        <input className="w-full rounded-2xl border border-gray-200 px-4 py-2.5" defaultValue="My blog" />
      </div>
      <div>
        <p className="text-sm font-semibold text-gray-900">Blog description</p>
        <textarea className="w-full rounded-2xl border border-gray-200 px-4 py-2.5" rows={3} defaultValue="Technical blog" />
      </div>
    ...
    <div className="rounded-3xl border border-gray-100 bg-white shadow-sm p-6 space-y-4">
      ...
      <div className="rounded-2xl border border-dashed border-gray-200 px-4 py-3 text-xs text-gray-500">
        Configure icon and banner uploads, hero copy, and related brand assets here.
      </div>
      <button className="rounded-2xl bg-gray-900 px-6 py-2 text-sm font-semibold text-white">Save</button>
    </div>
  </div>
    ...
    <div className="min-h-screen bg-[#f4f6fb]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
        <header className="space-y-2">
          <p className="text-3xl font-semibold text-gray-900">Settings</p>
          <p className="text-sm text-gray-500">Manage your profile, blog, and notifications</p>
        </header>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white">
          ...
          <div className="p-6 space-y-8">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your account basics</p>
            </div>
            {profileCard}

            <div>
              <p className="text-base font-semibold text-gray-900">Blog settings</p>
              <p className="text-sm text-gray-500">Example layout for `/settings/blog`</p>
            </div>
            {blogCard}
          </div>
        </div>
