    ...
    <div className="p-8">
      <div className="mb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-full">Coming Soon</span>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="pb-4 border-b border-gray-200">
              <h4 className="text-sm font-medium text-gray-700 mb-3">활동 알림</h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <FiMessageSquare className="mr-2 text-gray-400" />
                    <div>
                      <label htmlFor="email-comments" className="text-sm font-medium text-gray-700">
                        새 댓글
                      </label>
                      <p className="text-xs text-gray-500">내 글에 새 댓글이 달렸을 때</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <label htmlFor="email-likes" className="text-sm font-medium text-gray-700">
                        좋아요
                      </label>
                      <p className="text-xs text-gray-500">내 글을 좋아요 했을 때</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <label htmlFor="email-follows" className="text-sm font-medium text-gray-700">
                        새 팔로워
                      </label>
                      <p className="text-xs text-gray-500">누군가 나를 팔로우했을 때</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
            ...
            <div className="pb-4 border-b border-gray-200">
              <h4 className="text-sm font-medium text-gray-700 mb-3">리포트</h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <FiTrendingUp className="mr-2 text-gray-400" />
                    <div>
                      <label htmlFor="email-weekly" className="text-sm font-medium text-gray-700">
                        주간 리포트
                      </label>
                      <p className="text-xs text-gray-500">매주 블로그 통계 요약</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <FiTrendingUp className="mr-2 text-gray-400" />
                    <div>
                      <label htmlFor="email-monthly" className="text-sm font-medium text-gray-700">
                        월간 리포트
                      </label>
                      <p className="text-xs text-gray-500">매월 블로그 통계 요약</p>
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
            ...
            {/* Marketing */}
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-3">마케팅</h4>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <FiDollarSign className="mr-2 text-gray-400" />
                  <div>
                    <label htmlFor="email-marketing" className="text-sm font-medium text-gray-700">
                      프로모션 및 업데이트
                    </label>
                    <p className="text-xs text-gray-500">새로운 기능과 이벤트 소식</p>
                  </div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <FiMessageSquare className="mr-2 text-gray-400" />
                <div>
                  <label htmlFor="push-comments" className="text-sm font-medium text-gray-700">
                    새 댓글
                  </label>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <FiHeart className="mr-2 text-gray-400" />
                <div>
                  <label htmlFor="push-likes" className="text-sm font-medium text-gray-700">
                    좋아요
                  </label>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <FiUserPlus className="mr-2 text-gray-400" />
                <div>
                  <label htmlFor="push-follows" className="text-sm font-medium text-gray-700">
                    새 팔로워
                  </label>
                </div>
              </div>
