...
const navPrimary = [
  { label: '홈 피드', href: '/mock-home-shell-harbor-white', active: true },
  { label: '토론', href: '/c' },
...
export default function MockHomeShellHarborWhitePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1B2430] tracking-[0.01em] dark:bg-[#0E141B] dark:text-[#E6EDF3]">
      <div className="relative">
        <header className="sticky top-0 z-10 border-b border-[#D9E0EA]/80 bg-white/80 backdrop-blur dark:border-[#2A3645] dark:bg-[#0E141B]/70">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-4">
            ...
            <div className="flex flex-1 items-center justify-center gap-3 md:justify-end">
              <div className="flex w-full max-w-md items-center gap-2 rounded-full border border-[#D9E0EA] bg-[#F7F9FC] px-4 py-2 shadow-sm focus-within:ring-2 focus-within:ring-[#264653]/40 dark:border-[#2A3645] dark:bg-[#131A22] dark:focus-within:ring-[#6CC3B2]/40">
              ...
              <button
                ...
                disabled={!mounted}
                aria-pressed={isDark}
                className="inline-flex items-center gap-2 rounded-full border border-[#D9E0EA] bg-[#F7F9FC] px-4 py-2 text-sm font-semibold text-[#1B2430] shadow-sm transition-colors hover:bg-[#EEF3F8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-70 dark:border-[#2A3645] dark:bg-[#131A22] dark:text-[#E6EDF3] dark:hover:bg-[#1A232E] dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
              >
                <span>다크 모드</span>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 pb-16 pt-10 lg:grid-cols-[240px_minmax(0,1fr)]">
          <aside className="space-y-6">
            <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-5 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
              ...
              <div className="mt-4 space-y-2">
                {quickActions.map((action) => (
                  <Link
                    ...
                    href={action.href}
                    prefetch={false}
                    className="flex items-center justify-between rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] px-3 py-2 text-sm font-semibold text-[#1B2430] transition-colors hover:bg-[#DCE3EC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-[#2A3645] dark:bg-[#1A232E] dark:text-[#E6EDF3] dark:hover:bg-[#223040] dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
                  >
                    {action.label}
              ...
              <nav className="mt-4 space-y-2">
                {navPrimary.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    prefetch={false}
                    className={`flex items-center justify-between rounded-2xl px-3 py-2 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B] ${
                      item.active
                ...
                <div className="mt-3 space-y-2">
                  {navSecondary.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      prefetch={false}
                      className="flex items-center justify-between rounded-2xl px-3 py-2 text-sm font-semibold text-[#1B2430] transition-colors hover:bg-[#E6ECF4] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:text-[#E6EDF3] dark:hover:bg-[#1A232E] dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
                    >
                      {item.label}
                      <span className="text-xs text-[#9AA4B2] dark:text-[#728093]">↗</span>
                    </Link>
            ...
            <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-5 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
              ...
              <div className="mt-4 space-y-3">
                {spaces.map((space) => (
                  <div
                    key={space.name}
                    className="flex items-center justify-between rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] px-3 py-2 dark:border-[#2A3645] dark:bg-[#1A232E]"
                  >
                    <div>
          ...
          <main className="space-y-6">
            <section className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_340px]">
              <div className="space-y-6">
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-8 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  ...
                  <div className="mt-6 flex flex-wrap items-center gap-3">
                    <Link
                      href="/community"
                      prefetch={false}
                      className="rounded-full bg-[#1B2430] px-5 py-2.5 text-sm font-semibold text-[#F9FBFD] shadow-sm transition-colors hover:bg-[#242E3C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:bg-[#E6EDF3] dark:text-[#0E141B] dark:hover:bg-white dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
                    >
                      피드 둘러보기
                    </Link>
                    <Link
                      href="/docs"
                      prefetch={false}
                      className="rounded-full border border-[#D9E0EA] bg-[#F7F9FC] px-5 py-2.5 text-sm font-semibold text-[#1B2430] shadow-sm transition-colors hover:bg-[#EEF3F8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-[#2A3645] dark:bg-[#131A22] dark:text-[#E6EDF3] dark:hover:bg-[#1A232E] dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
                    >
                      커뮤니티 핸드북
                    </Link>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  {momentumStats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-2xl border border-[#D9E0EA] bg-[#F7F9FC] p-5 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]"
                    >
                ...
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-8 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <Link
                      href="/c"
                      prefetch={false}
                      className="rounded-full border border-[#D9E0EA] px-4 py-2 text-sm font-semibold text-[#1B2430] shadow-sm transition-colors hover:bg-[#EEF3F8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#264653] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-[#2A3645] dark:text-[#E6EDF3] dark:hover:bg-[#1A232E] dark:focus-visible:ring-[#6CC3B2] dark:focus-visible:ring-offset-[#0E141B]"
                    >
                      전체 보기
                    </Link>
                  </div>
                  <div className="mt-6 space-y-5">
                    {trendingDebates.map((thread) => (
                      <article
                        key={thread.title}
                        className="rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] p-5 dark:border-[#2A3645] dark:bg-[#1A232E]"
                      >
                ...
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-8 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <Link
                      href="/blog"
                      prefetch={false}
                      className="rounded-full border border-[#D9E0EA] px-4 py-2 text-sm font-semibold text-[#1B2430] shadow-sm transition-colors hover:bg-[#EEF3F8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1F3B73] focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-[#2A3645] dark:text-[#E6EDF3] dark:hover:bg-[#1A232E] dark:focus-visible:ring-[#8FB3E6] dark:focus-visible:ring-offset-[#0E141B]"
                    >
                      포스트 보기
                    </Link>
                  </div>
              ...
              <aside className="space-y-6">
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-6 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  ...
                  <div className="mt-6 space-y-4">
                    {liveSignals.map((item) => (
                      <div
                        key={item.text}
                        className="rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] p-4 shadow-sm dark:border-[#2A3645] dark:bg-[#1A232E]"
                      >
                        <p className="text-sm font-semibold text-[#1B2430] dark:text-[#E6EDF3]">
                          {item.text}
                        </p>
                ...
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-6 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  ...
                  <div className="mt-4 space-y-3">
                    {aiTrends.map((trend) => (
                      <div
                        key={trend.label}
                        className="flex items-center justify-between rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] px-4 py-3 dark:border-[#2A3645] dark:bg-[#1A232E]"
                      >
                ...
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-6 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  ...
                  <div className="mt-4 space-y-3">
                    {openSourceRadar.map((repo) => (
                      <div
                        key={repo.repo}
                        className="rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] p-4 dark:border-[#2A3645] dark:bg-[#1A232E]"
                      >
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-semibold text-[#1B2430] dark:text-[#E6EDF3]">
                            {repo.repo}
                ...
                <div className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-6 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
                  ...
                  <div className="mt-4 space-y-3">
                    {contributors.map((person) => (
                      <div
                        key={person.name}
                        className="flex items-center gap-3 rounded-2xl border border-[#D9E0EA] bg-[#EEF3F8] px-4 py-3 dark:border-[#2A3645] dark:bg-[#1A232E]"
                      >
            ...
            <section className="rounded-3xl border border-[#D9E0EA] bg-[#F7F9FC] p-8 shadow-sm dark:border-[#2A3645] dark:bg-[#131A22]">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-[#4B5563] dark:text-[#A9B4C2]">
                    다크 모드 색상 구성을 페이지에서 바로 확인할 수 있습니다.
                  </p>
                </div>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {darkPalette.map((color) => (
                  <div
                    key={color.name}
                    className="rounded-2xl border border-[#D9E0EA] bg-white p-4 dark:border-[#2A3645] dark:bg-[#0E141B]"
                  >
                    <div
