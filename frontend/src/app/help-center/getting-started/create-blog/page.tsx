...
export default function CreateBlogArticlePage() {
  ...
  const sections: Section[] = [
        ...
        <div className="space-y-4">
          ...
          <div className="bg-accent border border-border rounded-lg p-4">
            <div className="flex items-start">
              <FiInfo className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <div className="ml-3">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-muted-foreground">블로그를 만들기 전에 다음 사항을 확인하세요:</p>
          <ul className="space-y-2">
            <li className="flex items-start">
              <FiCheckCircle className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="ml-3 text-muted-foreground">MyBlog 계정이 있어야 합니다</span>
            </li>
            <li className="flex items-start">
              <FiCheckCircle className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="ml-3 text-muted-foreground">이메일 인증이 완료되어 있어야 합니다</span>
            </li>
            <li className="flex items-start">
              <FiCheckCircle className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <span className="ml-3 text-muted-foreground">블로그 이름과 URL을 미리 정해두세요</span>
            </li>
          </ul>
        </div>
      )
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h4 className="font-semibold text-foreground mb-2">로그인하기</h4>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h4 className="font-semibold text-foreground mb-2">블로그 생성 페이지로 이동</h4>
                <p className="text-muted-foreground mb-3">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h4 className="font-semibold text-foreground mb-2">블로그 정보 입력</h4>
                <p className="text-muted-foreground mb-3">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h4 className="font-semibold text-foreground mb-2">블로그 생성 완료</h4>
                <p className="text-muted-foreground mb-3">
                  "블로그 만들기" 버튼을 클릭하면 블로그가 생성되고 자동으로 블로그 홈으로 이동합니다.
                </p>
                <div className="bg-accent border border-border rounded-lg p-4">
                  <div className="flex items-start">
                    <FiCheckCircle className="w-5 h-5 text-foreground mt-0.5" />
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <h4 className="font-semibold text-foreground">✅ 권장사항</h4>
            <ul className="space-y-2 text-muted-foreground">
          ...
          <div className="space-y-3">
            <h4 className="font-semibold text-foreground">❌ 피해야 할 것</h4>
            <ul className="space-y-2 text-muted-foreground">
          ...
          <div className="bg-muted rounded-lg p-4">
            <p className="text-sm font-semibold text-foreground mb-2">좋은 예시:</p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Link href="/help-center/getting-started/first-post" 
              ...
              <h4 className="font-semibold text-foreground mb-2">첫 글 작성하기</h4>
            ...
            <Link href="/help-center/getting-started/profile-setup"
                  className="block p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
              <h4 className="font-semibold text-foreground mb-2">프로필 설정하기</h4>
              <p className="text-sm text-muted-foreground">
            ...
            <Link href="/help-center/getting-started/customize"
                  className="block p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
              <h4 className="font-semibold text-foreground mb-2">블로그 커스터마이징</h4>
              <p className="text-sm text-muted-foreground">
            ...
            <Link href="/help-center/writing/markdown"
                  className="block p-4 border border-border rounded-lg hover:shadow-md transition-shadow">
              <h4 className="font-semibold text-foreground mb-2">마크다운 가이드</h4>
              <p className="text-sm text-muted-foreground">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="bg-accent border border-border rounded-lg p-4">
            <div className="flex items-start">
              <FiAlertCircle className="w-5 h-5 text-foreground mt-0.5 flex-shrink-0" />
              <div className="ml-3">
                <p className="text-sm text-foreground">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <nav className="flex items-center text-sm">
                ...
                <FiChevronRight className="w-4 h-4 mx-2 text-muted-foreground" />
                <Link href="/help-center#getting-started" className="text-muted-foreground hover:text-foreground">
                  시작하기
                </Link>
                <FiChevronRight className="w-4 h-4 mx-2 text-muted-foreground" />
                <span className="text-foreground font-medium">블로그 만들기</span>
              </nav>
            </div>
        ...
        <div className="flex gap-8">
          ...
          <main className="flex-1 max-w-3xl">
            <header className="mb-8">
              <h1 className="text-3xl font-bold text-foreground mb-4">블로그 만들기</h1>
          ...
          <aside className="hidden xl:block w-64 flex-shrink-0">
            <div className="sticky top-24">
              <h3 className="text-sm font-semibold text-foreground mb-3">관련 문서</h3>
              ...
              <div className="mt-8 p-4 bg-muted rounded-lg">
                <FiBookOpen className="w-5 h-5 text-muted-foreground mb-2" />
                <p className="text-sm font-medium text-foreground mb-1">도움이 필요하신가요?</p>
