...
export default function SupportPage() {
  ...
  return (
    <DocsPageLayout
      ...
      description="문서에서 해결되지 않는 문제를 지원 흐름으로 바로 연결할 수 있도록 정리한 페이지입니다. 설정, 문제 재현, 운영 정책 확인까지 docs와 같은 리듬으로 이어집니다."
      toc={toc}
      eyebrow="Support"
    >
      <section id="contact">
        ...
        <p>
          우선 문서를 통해 설정과 연결 방식을 다시 확인하고, 여전히 해결되지 않으면 피드백 채널로
          바로 전달하는 흐름을 권장합니다. support는 docs의 연장선으로 동작해야 하므로,
          필요한 액션만 짧고 명확하게 배치했습니다.
        </p>
      ...
      <section id="faq">
        ...
        <p>
          자주 반복되는 질문은 따로 모아 간단하게 답변했습니다. 더 긴 설명이 필요한 항목은 문서로
          바로 이동할 수 있게 연결해 두었습니다.
        </p>
