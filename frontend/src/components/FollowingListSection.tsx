    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h3 className="text-lg font-semibold text-gray-900 mb-5 flex items-center gap-2">
          ...
          Following <span className="text-sm font-normal text-gray-500">({followingData?.total || 0})</span>
        </h3>
        ...
        {isLoadingFollowing ? (
          ...
          <div className="space-y-4">
            {followingData.data.map((user: any) => (
              <div key={user.id} className="flex items-center justify-between gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                <UserLinkWithTooltip
                  userId={user.id}
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
        <h3 className="text-lg font-semibold text-gray-900 mb-5 flex items-center gap-2">
          ...
          Followers <span className="text-sm font-normal text-gray-500">({followersData?.total || 0})</span>
        </h3>
