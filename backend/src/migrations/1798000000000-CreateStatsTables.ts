...
export class CreateStatsTables1798000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // 새로 추가한 성능 인덱스 삭제
    await queryRunner.query(`DROP INDEX IF EXISTS idx_community_members_joined;`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_community_members_active;`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_community_posts_upvotes;`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_community_posts_hot_score;`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_community_posts_weekly_stats;`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_posts_blog_weekly_stats;`);
    ...
    await queryRunner.dropIndex('stats_snapshot', 'idx_stats_snapshot_target_period');
