...
export class AddPostStatsColumns1792000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_posts_blog_like_count" ON "posts" ("blogId", "like_count" DESC)`);
        await queryRunner.query(`CREATE INDEX "IDX_posts_blog_view_count" ON "posts" ("blogId", "view_count" DESC)`);
