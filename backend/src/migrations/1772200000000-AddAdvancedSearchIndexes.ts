...
export class AddAdvancedSearchIndexes1772200000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS idx_messages_conversation_time`);
        ...
        await queryRunner.query(`DROP TRIGGER IF EXISTS trigger_post_search_vector_update`);
        await queryRunner.query(`DROP FUNCTION IF EXISTS update_post_search_vector()`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_post_metadata_category_editor`);
