...
export class AddPaymentHistoryFields1759087856008 implements MigrationInterface {
    name = 'AddPaymentHistoryFields1759087856008'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "provider" character varying`);
        await queryRunner.query(`ALTER TABLE "payment_history" ADD "providerId" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_history_status_enum_old" AS ENUM('pending', 'succeeded', 'failed', 'refunded')`);
        await queryRunner.query(`ALTER TABLE "payment_history" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "providerId"`);
        await queryRunner.query(`ALTER TABLE "payment_history" DROP COLUMN "provider"`);
    }
