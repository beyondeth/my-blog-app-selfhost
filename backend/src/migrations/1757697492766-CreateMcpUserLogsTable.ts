...
export class CreateMcpUserLogsTable1757697492766 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mcp_user_logs" DROP CONSTRAINT IF EXISTS "FK_mcp_user_logs_api_key_id"`);
        await queryRunner.query(`ALTER TABLE "mcp_user_logs" DROP CONSTRAINT IF EXISTS "FK_mcp_user_logs_user_id"`);
