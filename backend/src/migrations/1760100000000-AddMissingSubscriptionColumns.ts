 ...
 */
export class AddMissingSubscriptionColumns1760100000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // 인덱스 제거
        await queryRunner.query(`DROP INDEX "public"."IDX_user_subscriptions_cancelAtPeriodEnd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_user_subscriptions_trialEndDate"`);

        // 컬럼 제거 (역순)
        await queryRunner.query(`ALTER TABLE "user_subscriptions" DROP COLUMN "cancelAtPeriodEnd"`);
        await queryRunner.query(`ALTER TABLE "user_subscriptions" DROP COLUMN "paymentMethodId"`);
        await queryRunner.query(`ALTER TABLE "user_subscriptions" DROP COLUMN "paymentSubscriptionId"`);
        await queryRunner.query(`ALTER TABLE "user_subscriptions" DROP COLUMN "paymentCustomerId"`);
        await queryRunner.query(`ALTER TABLE "user_subscriptions" DROP COLUMN "trialEndDate"`);
    }
}
