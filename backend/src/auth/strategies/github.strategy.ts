...
export class GitHubStrategy extends PassportStrategy(Strategy, 'github') {
  constructor(
    ...
    super({
      ...
      callbackURL: configService.get('GITHUB_CALLBACK_URL') || 'http://localhost:3000/api/v1/auth/github/callback',
      scope: ['user:email'], // Request email scope to get user's email
    });
    
    // Store whether GitHub OAuth is properly configured
    this.isConfigured = !!(clientID && clientSecret && clientID !== 'your-github-client-id');
  }
