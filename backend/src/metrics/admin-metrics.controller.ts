...
export class AdminMetricsController {
  ...
  async getCacheMetricsPreview(): Promise<string[]> {
    ...
    return lines.filter(
      (line) => line.includes("cache_") && !line.startsWith("#"),
    );
  }
    ...
    try {
      ...
      return {
        ...
        chatQueue: {
          ...
          processingStatus:
            metrics["chat_processing_status"] === 1 ? "Processing" : "Idle",
          ...
          redisConnectionStatus:
            metrics["chat_redis_connection_status"] === 1
              ? "Connected"
              : "Disconnected",
          activeWebSocketConnections:
            metrics["chat_websocket_connections_active"] || 0,
        },
        redis: {
