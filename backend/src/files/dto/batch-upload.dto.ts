import { IsArray, IsString, IsNumber, IsOptional, IsIn, MaxLength, Min, Max, ValidateNested, ArrayMaxSize } from 'class-validator';
...
export class CreateBatchUploadUrlDto {
  ...
  @Type(() => BatchFileUploadDto)
  @ArrayMaxSize(5, { message: '한 번에 최대 5개의 파일만 업로드할 수 있습니다.' })
