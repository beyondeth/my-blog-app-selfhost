...
const EMAIL_BRAND_NAME = process.env.EMAIL_BRAND_NAME || "Aigory";
const EMAIL_COPYRIGHT_HOLDER =
  process.env.EMAIL_COPYRIGHT_HOLDER || "beyondeth";
const EMAIL_COPYRIGHT_YEAR = process.env.EMAIL_COPYRIGHT_YEAR || "2026";
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Amazon Ember', Roboto, Arial, sans-serif; background-color: #ffffff; color: #232f3e;">
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <div style="background: #232f3e; padding: 24px; text-align: center; border-radius: 8px 8px 0 0;">
          <div style="color: #ff9900; font-size: 24px; font-weight: 700; margin: 0;">${EMAIL_BRAND_NAME}</div>
        </div>
        <div style="background: #ffffff; border: 1px solid #d5d9d9; border-top: none; border-radius: 0 0 8px 8px; padding: 40px;">
          <h1 style="font-size: 24px; font-weight: 700; color: #232f3e; margin: 0 0 8px;">${EMAIL_BRAND_NAME} 이메일 인증 코드</h1>
          ...
          <p style="font-size: 14px; color: #232f3e; line-height: 1.8; margin: 0 0 24px;">
            ${EMAIL_BRAND_NAME} 사이트에 오신 것을 환영합니다! ${EMAIL_BRAND_NAME} ID는 블로그를 이용할 때 필요한 계정입니다.
          </p>
          <p style="font-size: 14px; color: #232f3e; line-height: 1.8; margin: 0 0 24px;">
            본인 확인이 필요합니다. 다음 확인 코드를 입력하십시오. ${EMAIL_BRAND_NAME} ID를 생성할 때 이 코드가 필요합니다.
          </p>
          ...
          <p style="font-size: 12px; color: #687078; line-height: 1.6; margin: 32px 0 0;">
            ${EMAIL_BRAND_NAME}는 귀하에게 이메일을 발송하여 암호, 신용 카드 또는 은행 계좌 번호를 요청하지 않습니다. 이러한 정보를 요청하는 이메일을 받으시면 응답하지 마십시오.
          </p>
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="font-size: 12px; color: #687078; margin: 0; line-height: 1.6;">
              © ${EMAIL_COPYRIGHT_YEAR} ${EMAIL_COPYRIGHT_HOLDER}. All rights reserved.<br>
              이 메시지는 ${EMAIL_BRAND_NAME}에서 전송되었습니다.
            </p>
          </div>
        </div>
      </div>
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Amazon Ember', Roboto, Arial, sans-serif; background-color: #ffffff; color: #232f3e;">
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <div style="background: #ffffff; border: 1px solid #d5d9d9; border-top: none; border-radius: 0 0 8px 8px; padding: 40px;">
          ...
          <p style="font-size: 14px; color: #232f3e; line-height: 1.8; margin: 0 0 24px;">
            귀하의 ${EMAIL_BRAND_NAME} 계정에 대한 비밀번호 재설정 요청을 받았습니다.
          </p>
          <p style="font-size: 14px; color: #232f3e; line-height: 1.8; margin: 0 0 24px;">
          ...
          <p style="font-size: 12px; color: #687078; line-height: 1.6; margin: 16px 0 0;">
            ${EMAIL_BRAND_NAME}는 귀하에게 이메일을 발송하여 암호, 신용 카드 또는 은행 계좌 번호를 요청하지 않습니다.
          </p>
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="font-size: 12px; color: #687078; margin: 0; line-height: 1.6;">
              © ${EMAIL_COPYRIGHT_YEAR} ${EMAIL_COPYRIGHT_HOLDER}. All rights reserved.<br>
      ...
      <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <div style="background: #ffffff; border: 1px solid #d5d9d9; border-top: none; border-radius: 0 0 8px 8px; padding: 48px 40px; text-align: center;">
          ...
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb;">
            <p style="font-size: 12px; color: #687078; margin: 0; line-height: 1.6;">
              이 메일은 보안 알림입니다.<br>
              © ${EMAIL_COPYRIGHT_YEAR} ${EMAIL_COPYRIGHT_HOLDER}. All rights reserved.
            </p>
          </div>
        </div>
      </div>
