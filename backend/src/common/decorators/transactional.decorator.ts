...
export function Transactional() {
  return function (
    ...
    descriptor.value = async function (...args: any[]) {
      ...
      if (!dataSource) {
        throw new Error('DataSource not found in service. Please inject it in the constructor.');
      }
 ...
 */
export function RetryableTransaction(maxRetries: number = 3, retryDelay: number = 100) {
  return function (
    target: any,
    propertyKey: string,
    descriptor: PropertyDescriptor
